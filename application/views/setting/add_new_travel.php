...
<a href="#page-stats" class="block-heading" data-toggle="collapse">List Travel</a>
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered">
		...
		{ 
			...
			<tr>
				...
				<td><center><?php echo anchor('setting/admin/void_travel/'.$row_rm['id_travel']/*, img(array('src'=>"wp-theme/images/control/16/busy.png", 'alt'=>'Delete SMU', 'title'=>'Delete SMU'))*/,'delete'); ?></td>
            </tr><?php } } ?>
        </tbody>
    </table>
</div>
